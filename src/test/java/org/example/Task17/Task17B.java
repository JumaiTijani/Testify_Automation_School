...
public class Task17B {
    ...
    public void forms(){
        ...
        String demoqaForms =  "Practice Form";

        WebElement practiceForm = driver.findElement(By.xpath("//span[contains(text(),'Practice Form')]"));

        SoftAssert contact = new SoftAssert();
        contact.assertEquals(demoqaForms, practiceForm.getText());
        contact.assertAll();
    }
}
