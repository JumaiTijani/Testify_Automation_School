...
public class Task17C {
    ...
    public void widgets(){
        ...
        String demoqaElement =  "Accordian";

        WebElement accordian = driver.findElement(By.xpath("//span[contains(text(),'Accordian')]"));

        SoftAssert contact = new SoftAssert();
        contact.assertEquals(demoqaElement, accordian.getText());
        contact.assertAll();
    }
}
